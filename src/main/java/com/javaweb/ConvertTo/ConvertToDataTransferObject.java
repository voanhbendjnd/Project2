...
//		dto.setNumberofbasement(enty.getNumberofbasement());
...
//		if(enty.getDistrict() != null) building.setAddress(enty.getStreet() + ", " + enty.getWard() + ", " +  enty.getDistrict().getName());
//		else building.setAddress(enty.getStreet() + ", " + enty.getWard());
